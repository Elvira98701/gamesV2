...
const buttonVariants = cva(
  "inline-flex items-center font-bold uppercase justify-center gap-2 whitespace-nowrap rounded-3xl text-sm transition-all focus-visible:ring-1 focus-visible:ring-ring active:translate-y-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
